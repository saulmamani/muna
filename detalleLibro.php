...
<div class="container">
    ...
    <div style="text-align: center; margin-top: 10px">
        <p style="text-align: right;">
            <a href="javascript:abrirVentanaTutor('tutor/tutor_detallelibro.html')" data-toggle="tooltip"
               title="Ataques" id="btnAtaque">Ataque <span class="glyphicon glyphicon-edit"
                                                           aria-hidden="true"></span></a>
            || <a href="javascript:abrirVentanaTutor('tutor/tutor_detallelibro.html#defensa')" data-toggle="tooltip"
        ...
        <?php $result = $obj->BuscarPorId($idLibro); ?>
        ...
        <?php while ($f = mysqli_fetch_array($result)): ?>
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <a href="<?php echo utf8_encode($f['Url']); ?>" class="btn btn-success"><span
                                class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> Descargar</a>
                </div>
                <div class="col-md-6">
