...
$id = (!isset($_GET['id'])) ? '' : $_GET['id'];
	...
	//Seguridad: para evitar ataques XSS, el aseguramos que el $id sea un número y no un código malisioso
            ...
            <div class="header clearfix">
                <nav>
                    <ul class="nav nav-pills pull-right">
                        ...
                        <li role="presentation" class="active"><a href="perfil.php?id=<?php echo $_SESSION['IdUsuario']; ?>">Mi Perfil</a></li>
            ...
            <div style="text-align: center; margin-top: 10px">
                <h3><u>Mi Perfil</u></h3>
                  <p style="text-align: right;">
                     <a href="javascript:abrirVentanaTutor('tutor/tutor_perfil.html')" data-toggle="tooltip" title="Ataques" id="btnAtaque">Ataque <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                ...
                <?php while ($f = mysqli_fetch_array($result)): ?>
                    ...
                    <p>Nombre: <?php echo  utf8_encode($f['Nombre']); ?></p>
